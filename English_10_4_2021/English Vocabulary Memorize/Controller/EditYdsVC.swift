...
//
//  Created by Hasan BAL on 1.04.2021.
//

import UIKit
import CoreData

class EditYdsVC: UIViewController,UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "editYdsCell", for: indexPath) as! EditYdsCell
